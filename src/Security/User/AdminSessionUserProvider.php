...
namespace OxidEsales\SessionAuthComponent\Security\User;

use OxidEsales\Eshop\Application\Model\User;
use OxidEsales\Eshop\Core\Registry;
use OxidEsales\SessionAuthComponent\Security\Exception\CsrfTokenMismatchException;
use OxidEsales\SessionAuthComponent\Security\Exception\InsufficientAdminRightsException;
use OxidEsales\SessionAuthComponent\Security\Exception\NoActiveSessionUserException;
